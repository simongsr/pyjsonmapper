...
class Field(ABC):
    ...
    def __init__(self, validators=(), null=False, **kwargs) -> None:
    ...
    def validate(self, value) -> None:
        if self.null and self.__value is None:
            return
...
class ScalarField(Field):
    ...
    def __init__(self, serializer, validators=(), null=False, converter=lambda v: v) -> None:
        super().__init__(validators, null)
...
class StringField(ScalarField):
    ...
    def __init__(self, validators=(is_string, ), null=False, converter=lambda v: v) -> None:
        super().__init__(str, validators, null, converter)


class FloatField(ScalarField):

    def __init__(self, validators=(is_number, ), null=False, converter=lambda v: v) -> None:
        super().__init__(float, validators, null, converter)


class IntegerField(ScalarField):

    def __init__(self, validators=(is_number, ), null=False, converter=lambda v: v) -> None:
        super().__init__(int, validators, null, converter)


class BooleanField(ScalarField):

    def __init__(self, validators=(is_boolean, ), null=False, converter=lambda v: v) -> None:
        super().__init__(bool, validators, null, converter)


class ObjectField(Field):

    def __init__(self, model, validators=(), null=False, **kwargs) -> None:
        super().__init__(validators, null, **kwargs)
        self.model = model
...
def __scalar_field_factory_builder(field_cls, serializer=None):
